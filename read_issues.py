#!/usr/bin/env python3
"""
[DEPRECATED] JIRA 이슈 읽기 스크립트 — 사용하지 말 것.

이 스크립트는 터미널에 이슈 본문을 직접 출력하므로 UTF-8 깨짐과
파싱 실패 위험이 있습니다. 대신 search_issues.py 를 사용하세요.

search_issues.py 는 결과를 임시 markdown 파일에 저장하고 경로만 출력합니다.
상세: docs/reading.md
"""
